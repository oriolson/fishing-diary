export function BobberScene() {
  return (
    <div className="relative h-52 overflow-hidden rounded-[2rem] bg-[linear-gradient(180deg,color-mix(in_oklch,var(--water)_22%,var(--paper)),color-mix(in_oklch,var(--water)_52%,var(--paper)))]">
      ...
      <div className="bobber absolute left-1/2 top-20 -ml-4 h-12 w-8 overflow-hidden rounded-full border border-[color:var(--mud)]/35 bg-[color:var(--paper)] shadow-sm">
